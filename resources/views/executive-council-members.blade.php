...
@section('header_title','Members of Executive Council')
@section('header_subtitle','Meet the members driving the state\'s governance and development.')
@section('content')

    <a class="inline-flex items-center gap-2 mb-8 text-stone-700 dark:text-stone-300 hover:text-stone-900 dark:hover:text-white transition-colors" href="{{ route('executive-council') }}">
    ...
    @include('custom.pagination', ['paginator' => $members])
