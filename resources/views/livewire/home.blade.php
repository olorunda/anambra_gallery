                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div class="flex flex-col justify-between">
                        ...
                        <div class="mt-8 text-center lg:text-left">
                            ...
                            <a class="mt-6 inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-bold text-gray-900 shadow-lg transition-transform hover:scale-105" href="{{ route('about') }}" wire:navigate>
                                About Anambra
