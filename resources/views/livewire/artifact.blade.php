<div>
    ...
    <a class="inline-flex items-center gap-2 mb-8 text-stone-700 dark:text-stone-300 hover:text-stone-900 dark:hover:text-white transition-colors" href="{{ route('history-culture') }}" wire:navigate>
            ...
            <div class="relative max-w-4xl max-h-screen p-4 w-full flex flex-col items-center">
                ...
                <div class="relative w-full flex justify-center">
                    <img 
                        ...
                        :alt="`{{ $artifact->title }} - Image ${currentModalSlide + 1}`"
