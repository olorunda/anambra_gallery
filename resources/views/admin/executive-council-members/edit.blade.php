...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <form method="POST" id="submitForm" action="{{ route('admin.executive-council-members.update', $member) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div id="no-preview" class="bg-light d-flex align-items-center justify-content-center"
                                                ...
                                                <div class="text-center text-muted">
                                                    ...
                                                    <p class="small mb-0 mt-2">Select file to preview</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
