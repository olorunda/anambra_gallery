...
@section('page_title', 'Add Artifact')
@section('page_description', 'Add a new artifact to the gallery')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Add New Artifact</h5>
            ...
            <form method="POST" action="{{ route('admin.artifacts.store') }}" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                          ...
                                          placeholder="Enter detailed description of the artifact, its history, significance, and cultural context..." required>{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="border border-2 border-dashed rounded p-3" id="image-upload-area">
                                    <div class="text-center mb-3">
                                        ...
                                        <p class="mb-2">Upload artifact images</p>
                ...
                <div class="card-footer d-flex justify-content-end gap-2">
                    <a href="{{ route('admin.artifacts.index') }}" class="btn btn-secondary">Cancel</a>
