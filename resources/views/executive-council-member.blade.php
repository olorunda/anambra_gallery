...
@section('header_title','Executive Council Member')
@section('header_subtitle','Meet the members driving the state\'s governance and development.')
@section('content')

    <a class="inline-flex items-center gap-2 mb-8 text-stone-700 dark:text-stone-300 hover:text-stone-900 dark:hover:text-white transition-colors" href="{{ route('executive-council-members') }}">
...
{{--                    @endforeach--}}
            ...
            <div class="flex justify-between items-center mt-12 lg:mt-16">
                ...
                <div class="flex items-center gap-4">
                    @if($previousMember)
                        <a href="{{ route('executive-council-member', $previousMember->slug) }}" class="w-12 h-12 rounded-full border border-stone-300 dark:border-stone-600 flex items-center justify-center text-stone-700 dark:text-stone-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                            <span class="material-icons">arrow_back</span>
                        </a>
                    @else
                    ...
                    @if($nextMember)
                        <a href="{{ route('executive-council-member', $nextMember->slug) }}" class="w-12 h-12 rounded-full bg-primary flex items-center justify-center text-white hover:bg-yellow-500 transition-colors">
