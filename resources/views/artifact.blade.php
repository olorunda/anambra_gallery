...
{{--    <script src="https://cdn.tailwindcss.com?plugins=forms,typography"></script>--}}
    ...
    <link href="https://fonts.googleapis.com/css2?family=Libre+Baskerville:ital,wght@0,400;0,700;1,400&family=Karla:ital,wght@0,200..800;1,200..800&display=swap" rel="stylesheet"/>
    <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined" rel="stylesheet"/>

{{--    <a class="inline-flex items-center gap-2 mb-8 text-text-light dark:text-text-dark hover:underline" href="{{ route('history-culture') }}">--}}
{{--                <span class="material-symbols-outlined">arrow_back</span>--}}
{{--                Return back--}}
{{--            </a>--}}
    <a class="inline-flex items-center gap-2 mb-8 text-stone-700 dark:text-stone-300 hover:text-stone-900 dark:hover:text-white transition-colors" href="{{ route('history-culture') }}">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                <div class="flex flex-col items-center">
                    <div class="relative w-full max-w-lg">
                        @php
                            $images = $artifact->images->pluck('url')->toArray();
    ...
    <script>
        ...
        function openModal(imageIndex) {
            ...
            modalImage.alt = `{{ $artifact->title }} - Image ${currentModalSlide + 1}`;
